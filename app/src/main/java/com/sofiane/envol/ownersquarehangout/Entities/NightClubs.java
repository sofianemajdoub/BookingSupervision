...
public class NightClubs {
    ...
    public NightClubs(String address, String close_time, String lng, String lat, String name, String nbr_booking, String open_time, String phone, String image, String id) {
